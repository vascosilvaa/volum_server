...
var PersonalSettingsComponent = (function () {
    function PersonalSettingsComponent(profileService) {
        this.profileService = profileService;
        this.countries = [];
    }
    PersonalSettingsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.profileService.getCountries().then(function (res) {
            _this.countries = res;
            console.log("RES", res);
        });
    };
