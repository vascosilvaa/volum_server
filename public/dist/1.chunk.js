...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.engageConversation = function () {
        var _this = this;
        this.profileService.engageConversation(this.idProfile).then(function (res) {
            console.log(res);
