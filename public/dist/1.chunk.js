...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_edit_modal_edit_modal_component__ = __webpack_require__(548);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_services_profile_service__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_modal_view_all_modal_view_all_component__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_shared_module__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__details_details_component__ = __webpack_require__(904);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_angular2_google_maps_core__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__activity_activity_component__ = __webpack_require__(903);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__about_about_component__ = __webpack_require__(898);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__profile_routing__ = __webpack_require__(923);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__angular_router__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__angular_material__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ng_bootstrap_ng_bootstrap__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__angular_common__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__angular_forms__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__profile_component__ = __webpack_require__(909);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_ng2_bootstrap_accordion__ = __webpack_require__(890);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__new_action_new_action_component__ = __webpack_require__(908);
...
ProfileModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14__angular_core__["NgModule"])({
        ...
        providers: [
            { provide: __WEBPACK_IMPORTED_MODULE_14__angular_core__["LOCALE_ID"], useValue: "pt-PT" }, __WEBPACK_IMPORTED_MODULE_2__shared_services_profile_service__["a" /* ProfileService */], __WEBPACK_IMPORTED_MODULE_0__shared_services_vols_service__["a" /* volsService */]
        ],
        entryComponents: [__WEBPACK_IMPORTED_MODULE_4__shared_modal_view_all_modal_view_all_component__["a" /* ModalViewAllComponent */], __WEBPACK_IMPORTED_MODULE_1__shared_edit_modal_edit_modal_component__["a" /* EditModalComponent */]]
    })
], ProfileModule);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_services_vols_service__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_services_profile_service__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_Auth_authentication_service__ = __webpack_require__(27);
    ...
    ActivityComponent.prototype.ngOnInit = function () {
        ...
        this.route.parent.params.subscribe(function (params) {
            ...
            _this.auth.userPromise.then(function (res) {
                _this.user = res.user;
                console.log("user2", _this.user);
                _this.observable = _this.profileService.dataString$.subscribe(function (data) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_edit_modal_edit_modal_component__ = __webpack_require__(548);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_services_vols_service__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_services_shared_service__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_services_profile_service__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_modal_end_modal_end_component__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_modal_view_all_modal_view_all_component__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_Auth_authentication_service__ = __webpack_require__(27);
...
var DetailsComponent = (function () {
    ...
    DetailsComponent.prototype.openEditModal = function (id_vol) {
        return this.modal.open(__WEBPACK_IMPORTED_MODULE_0__shared_edit_modal_edit_modal_component__["a" /* EditModalComponent */], __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_angular2_modal__["n" /* overlayConfigFactory */])({ id_vol: id_vol }, __WEBPACK_IMPORTED_MODULE_6_angular2_modal_plugins_bootstrap__["b" /* BSModalContext */]));
    };
    ...
    DetailsComponent.prototype.sendComment = function (comment) {
        ...
        if (typeof comment == 'string' && comment.length > 0 && comment && comment.replace(/^\s+/g, '').length) {
            this.volsService.sendComment(comment, this.idVol).then(function (res) {
                _this.comentario = '';
    ...
    DetailsComponent.prototype.openViewAll = function (type, idVol) {
        return this.modal.open(__WEBPACK_IMPORTED_MODULE_5__shared_modal_view_all_modal_view_all_component__["a" /* ModalViewAllComponent */], __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_angular2_modal__["n" /* overlayConfigFactory */])({ type: type, idVol: idVol }, __WEBPACK_IMPORTED_MODULE_6_angular2_modal_plugins_bootstrap__["b" /* BSModalContext */]));
    };
    DetailsComponent.prototype.openRemoveConfirm = function (type, idVol, idUser, name, i) {
        var _this = this;
        return this.modal.open(__WEBPACK_IMPORTED_MODULE_5__shared_modal_view_all_modal_view_all_component__["a" /* ModalViewAllComponent */], __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_angular2_modal__["n" /* overlayConfigFactory */])({ type: type, name: name, idVol: idVol, idUser: idUser, index: i }, __WEBPACK_IMPORTED_MODULE_6_angular2_modal_plugins_bootstrap__["b" /* BSModalContext */])).then(function (d) { return d.result; })
            .then(function (r) {
            console.log(r);
            var index = _this.candidates.findIndex(function (x) { return x.id_user == idUser; });
    ...
    DetailsComponent.prototype.openDelete = function (type, id_vol, date, name) {
        return this.modal.open(__WEBPACK_IMPORTED_MODULE_4__shared_modal_end_modal_end_component__["a" /* ModalEndComponent */], __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_angular2_modal__["n" /* overlayConfigFactory */])({ type: type, idVol: id_vol, date: date, name: name }, __WEBPACK_IMPORTED_MODULE_6_angular2_modal_plugins_bootstrap__["b" /* BSModalContext */]));
    };
    DetailsComponent.prototype.openRemoveConfirmCandidate = function (type, idVol, idUser, name, i) {
        var _this = this;
        return this.modal.open(__WEBPACK_IMPORTED_MODULE_5__shared_modal_view_all_modal_view_all_component__["a" /* ModalViewAllComponent */], __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_angular2_modal__["n" /* overlayConfigFactory */])({ type: type, name: name, idVol: idVol, idUser: idUser, index: i }, __WEBPACK_IMPORTED_MODULE_6_angular2_modal_plugins_bootstrap__["b" /* BSModalContext */])).then(function (d) { return d.result; })
            .then(function (r) {
            console.log(r);
    ...
    DetailsComponent.prototype.openEnd = function (type, idVol) {
        return this.modal.open(__WEBPACK_IMPORTED_MODULE_4__shared_modal_end_modal_end_component__["a" /* ModalEndComponent */], __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_angular2_modal__["n" /* overlayConfigFactory */])({ idVol: idVol, type: type }, __WEBPACK_IMPORTED_MODULE_6_angular2_modal_plugins_bootstrap__["b" /* BSModalContext */]));
    };
    ...
    DetailsComponent.prototype.edit = function (field) {
        if (field == 1) {
            if (this.editTitle == 1) {
                this.editTitle = 0;
            }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_services_shared_service__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_services_profile_service__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_Auth_authentication_service__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_component__ = __webpack_require__(551);
            ...
            _this.route.queryParams.subscribe((function (query) {
                ...
                if (query.id_token) {
                    ...
                    _this.auth.reloadUser(params.id, true).then(function (res) {
                        _this.injector.get(__WEBPACK_IMPORTED_MODULE_1__app_component__["a" /* AppComponent */]).getUser();
                    });
...
ProfileComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_0__shared_services_profile_service__["a" /* ProfileService */]],
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_6__angular_http__["c" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__angular_http__["c" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2_angular2_modal__["g" /* Overlay */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_angular2_modal__["g" /* Overlay */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewContainerRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewContainerRef"]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["c" /* ActivatedRoute */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_5__angular_core__["Injector"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_core__["Injector"]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_0__shared_services_profile_service__["a" /* ProfileService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__shared_services_profile_service__["a" /* ProfileService */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_3__shared_Auth_authentication_service__["a" /* AuthenticationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__shared_Auth_authentication_service__["a" /* AuthenticationService */]) === "function" && _h || Object])
], ProfileComponent);
