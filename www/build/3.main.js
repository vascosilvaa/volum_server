webpackJsonp([3,5],Array(270).concat([
/* 270 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__card__ = __webpack_require__(506);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_moment__ = __webpack_require__(444);
...
CardModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__card__["a" /* Card */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__card__["a" /* Card */]),
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_card_card_module__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__feed__ = __webpack_require__(629);
...
__WEBPACK_IMPORTED_MODULE_0__shared_card_card_module__["CardModule"];
...
FeedModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_3__feed__["a" /* Feed */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_0__shared_card_card_module__["CardModule"],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__feed__["a" /* Feed */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_3__feed__["a" /* Feed */]
        ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(301);
...
var Card = (function () {
    function Card(navCtrl, navParams, actionsheetCtrl, platform, popoverCtrl, auth) {
        ...
        //LIKE
        this.liked = false;
        __WEBPACK_IMPORTED_MODULE_3_moment__["locale"]('pt-pt');
    }
    Card.prototype.goDetails = function (id, name) {
        this.navCtrl.push("CardDetails", { volId: id, volName: name });
    };
    Card.prototype.like = function () {
        if (this.liked == false) {
            this.liked = true;
        }
        else {
    ...
    Card.prototype.openMenus = function (ev, creatorId, volId) {
        var popover = this.popoverCtrl.create("Popover", { creatorId: creatorId, volId: volId, popOver: 0 });
        popover.present({
            ev: ev
        });
    };
    Card.prototype.openComments = function (value) {
        this.navCtrl.push("Comments", { postId: value });
    };
    Card.prototype.openShare = function () {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], Card.prototype, "userCreator", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], Card.prototype, "verified", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], Card.prototype, "map", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], Card.prototype, "likes", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], Card.prototype, "idVol", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], Card.prototype, "photos", void 0);
Card = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* IonicPage */])(),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
        selector: 'volum-card',template:/*ion-inline-start:"C:\Users\Pedro\desktop\volum_mobile\src\shared\card\card.html"*/'<ion-card class="cardVolum" no-margin margin-bottom margin-top>\n\n\n\n    <!-- CARD HEADER -->\n\n    <ion-item class="cardHeader">\n\n        <ion-avatar item-left>\n\n            <img src="{{avatar}}">\n\n        </ion-avatar>\n\n        <p class="font-md bold font-primary">{{username}}</p>\n\n        <p ion-text color="grey3" class="marginTopNeg font-sm">{{dateCreation | amTimeAgo:true}}</p>\n\n        <button ion-button clear item-right icon-only color="grey3" (click)="openMenus($event, userCreator, idVol)">\n\n            <ion-icon name="more"></ion-icon>\n\n        </button>\n\n    </ion-item>\n\n\n\n    <!-- CARD CONTENT -->\n\n    <ion-card-content class="cardContent" (tap)="goDetails(idVol, name)" no-padding>\n\n\n\n\n\n       \n\n        <img [src]="photos[0]" *ngIf="photos.length == 1"/>\n\n\n\n\n\n        <!-- MAIS QUE UM IMAGEM -->\n\n        <ion-slides pager color="blue" class="slidecard" *ngIf="photos.length > 1">\n\n            <ion-slide class="cardSlide" *ngFor="let photo of photos">\n\n                <img [src]="photo"/>\n\n            </ion-slide>\n\n\n\n        </ion-slides>\n\n\n\n        <h2 padding-left padding-right ion-text color="grey4" class="font-md2 bold">{{name}}</h2>\n\n        <div class="descriptioCard" style="display: block!important;display: -webkit-box!important;-webkit-line-clamp: 2!important;-webkit-box-orient: vertical!important;overflow: hidden!important;text-overflow: ellipsis;">\n\n            <p padding-left padding-right ion-text color="grey4">{{description}}</p>\n\n        </div>\n\n    </ion-card-content>\n\n\n\n    <!-- CARD RESUME -->\n\n    <div class="row-resume">\n\n        <div class="col-card col-num-likes" color="red">\n\n            <ion-icon name="heart" class="iconlike" color="danger"></ion-icon>20\n\n        </div>\n\n        <!--\n\n        <div class="col-card col-num-comments">\n\n            10 comentários\n\n        </div>\n\n        -->\n\n        <div class="col-card-last col-num-shares">\n\n            2 partilhas\n\n        </div>\n\n    </div>\n\n\n\n    <!-- CARD ACTIONS -->\n\n    <div class="row-card">\n\n        <div class="col-card btnLike">\n\n            <button ion-button icon-left clear small no-padding color="grey3" [class.liked]="liked == true" (tap)="like()">\n\n                <ion-icon name="heart"></ion-icon>\n\n                <div>Gosto</div>\n\n            </button>\n\n        </div>\n\n    \n\n        <div class="col-card-middle">\n\n            <button ion-button icon-left clear small no-padding color="grey3" (tap)="openComments(1)">\n\n                <ion-icon name="bookmark"></ion-icon>\n\n                <div>Marcar</div>\n\n            </button>\n\n        </div>\n\n\n\n        <div class="col-card btnShare">\n\n            <button ion-button icon-left clear small no-padding color="grey3" (tap)="openShare()">\n\n                <ion-icon name="share-alt" class="colorShare"></ion-icon>\n\n                <div>Partilhar</div>\n\n            </button>\n\n        </div>\n\n    </div>\n\n\n\n</ion-card>\n\n\n\n'/*ion-inline-end:"C:\Users\Pedro\desktop\volum_mobile\src\shared\card\card.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["m" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* Platform */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* PopoverController */], __WEBPACK_IMPORTED_MODULE_0__auth_authentication_service__["a" /* AuthenticationService */]])
], Card);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__feed_service__ = __webpack_require__(628);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(99);
...
var Feed = (function () {
    function Feed(navParams, popoverCtrl, feedService, loadingCtrl) {
        var _this = this;
        this.navParams = navParams;
        this.popoverCtrl = popoverCtrl;
        ...
        loading.present();
        this.feedService.getVols().then(function (res) {
            _this.vols = res.vols;
            loading.dismiss();
        })
    ...
    //POPOVER HEADER
    Feed.prototype.openMenus = function (ev) {
        var popover = this.popoverCtrl.create("Popover", { typePopOver: '0' });
        popover.present({
            ev: ev
        });
    };
...
Feed = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* IonicPage */])(),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
        selector: 'page-feed',template:/*ion-inline-start:"C:\Users\Pedro\desktop\volum_mobile\src\pages\feed\feed.html"*/'<ion-header no-border>\n\n  <ion-toolbar color="primary">\n\n    <ion-title class="header-feed-title">\n\n         BEVOLUN\n\n    </ion-title>\n\n    <ion-buttons end>\n\n        <button ion-button icon-only color="white" (click)="openMenus($event)">\n\n            <ion-icon name="more"></ion-icon>\n\n        </button>\n\n    </ion-buttons>\n\n  </ion-toolbar>\n\n</ion-header>\n\n\n\n<ion-content class="content-background">\n\n    <volum-card *ngFor="let vol of vols" [idVol]="vol.vol.id_vol" [username]="vol.user.name" [userCreator]="vol.user.id_user" [dateCreation]="vol.vol.date_begin" [avatar]="vol.user.photo_url" [name]="vol.vol.name" [description]="vol.vol.description" [photos]="vol.vol.photos" [verified]="true"></volum-card>\n\n</ion-content> \n\n'/*ion-inline-end:"C:\Users\Pedro\desktop\volum_mobile\src\pages\feed\feed.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_0__feed_service__["a" /* FeedService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* PopoverController */], __WEBPACK_IMPORTED_MODULE_0__feed_service__["a" /* FeedService */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* LoadingController */]])
], Feed);
